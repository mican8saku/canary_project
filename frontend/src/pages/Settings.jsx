   ...
   <div className="bg-card rounded-3xl border border-border/60 shadow-sm overflow-hidden">
      <div className="px-4">
         <SettingRow
            ...
            onChange={(val) =>
         updateAutoSetting("curtain_routine_active", val)}
         />
      </div>
...
<div className="flex items-center justify-between py-4">
  ...
  <div className="flex items-center gap-3 bg-background px-4 py-2 rounded-xl border border-border/50 shadow-inner">
    <div className="flex items-center gap-2">
      ...
      <input 
        ...
        className="bg-transparent text-sm font-bold w-[45px] outline-none text-foreground text-center"
      />
    </div>
   ...
   <div className="px-4 border-t border-border/50">
      <SettingRow
         ...
         onChange={(val) =>
      updateAutoSetting("led_routine_active", val)}
      />
   </div>
